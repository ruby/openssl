...
class OpenSSL::TestPKey < OpenSSL::PKeyTestCase
  def test_generic_oid_inspect
    ...
    assert_match(/oid=X25519/, x25519.inspect)
  end
  ...
  def test_s_generate_parameters
    ...
    assert_raise(RuntimeError) do
      OpenSSL::PKey.generate_parameters('DSA') do |*args|
        cb_called << args
  ...
  def test_ed25519_not_approved_on_fips
    ...
    # for details.
    omit 'Ed25519 is allowed in the OpenSSL 3.0 FIPS code as a kind of bug' unless openssl?(3, 1, 0, 0)
