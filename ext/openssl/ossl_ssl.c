 ...
 * defined as constants in OpenSSL::SSL and begin with +OP_+.
 *
 * For backwards compatibility, passing +nil+ has the same effect as passing
 * OpenSSL::SSL::OP_ALL.
 *
 * See also man page SSL_CTX_set_options(3). Note that this method replaces all
 * options currently set in the context unlike the OpenSSL C API.
 */
static VALUE
